...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['role'])) {  // FIX: Change from 'role_id' to 'role'
        $userId = $_POST['user_id'];
        $role = $_POST['role']; // FIX: Matches JavaScript request
...
<script>
    ...
    $(".role-select").change(function () {
        ...
        $.post("manage_users.php", { user_id: userId, role: newRole }, function (response) {
            if (response.success) {
    ...
    $(".delete-btn").click(function () {
        if (confirm("Are you sure you want to delete this user?")) {
            ...
            $.post("manage_users.php", { user_id: userId, delete_user: true }, function (response) {
                if (response.success) {
